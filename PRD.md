...
> **Versi:** 0.3 — SMA Negeri X Rembang (rebrand dari referensi)
...
1. **Header/Navbar:** Kiri Logo SMA Negeri X Rembang | Tengah: Beranda, Profil, Program, Berita, Kontak | Kanan: Search + tombol PPDB/Kontak.
...
**Adaptasi SMA Negeri X Rembang:** Brand aktif adalah SMA Negeri X Rembang; layout referensi dipertahankan, copy & asset dikelola via CMS `siteSettings`.
...
|---|------------------------|-----------|-----------|------------|
| 1 | **Header/Navbar** | Logo SMA Negeri X Rembang, nav, search, CTA PPDB | P0 | `siteSettings.navigation` |
...
Tambahan SMA Negeri X Rembang (opsional P2): `/ppdb`, `/program/[slug]`, `/berita/[slug]` untuk detail.
...
Halaman Detail (CMS-driven):
  ...
  /teachers/[slug]
  /blog/[slug]
  /tentang, /ppdb, /kontak (opsional SMA Negeri X Rembang)
