    ...
    <section className="py-14 lg:py-16 bg-white">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3 lg:gap-4">
          {list.map((c:any)=>(
            <div key={c.title} className={"group relative flex flex-col items-center justify-center rounded-[20px] border p-6 text-center transition-all duration-200 min-h-[140px] w-[calc(50%-6px)] sm:w-[200px] lg:flex-1 lg:min-w-0 card-hover "+(c.active?"bg-[var(--green-dark)] text-white border-[var(--green-dark)] shadow-[0_12px_32px_rgba(9,58,39,0.25)]":"bg-[var(--bg-light)] border-black/5 hover:border-black/10 hover:bg-white")}>
              {c.active && <span className="absolute -top-2 left-1/2 -translate-x-1/2 px-2.5 py-1 rounded-full bg-[var(--yellow)] text-[var(--green-dark)] text-[10px] font-extrabold tracking-wide leading-none shadow-md whitespace-nowrap">★ Unggulan</span>}
