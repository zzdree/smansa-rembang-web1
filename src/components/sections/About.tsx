      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <motion.div initial={{opacity:0,y:16}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{duration:0.6,delay:0.08, ease:[0.22,1,0.36,1]}}>
            ...
            <p className="mt-3 text-[15px] leading-relaxed text-black/60 max-w-[52ch]">SMA Negeri 5 Rembang berkomitmen menghadirkan pendidikan berkualitas, lingkungan asri, dan pembinaan karakter. Akreditasi A, guru profesional, dan puluhan prestasi tiap tahun.</p>
            <div id="visi" className="mt-6 rounded-2xl bg-white border border-black/5 p-5 lg:p-6 shadow-sm scroll-mt-[80px]">
              ...
              <h3 id="sejarah" className="font-bold text-sm mt-5 scroll-mt-[80px]">Sejarah Singkat</h3><p className="text-sm text-black/60 mt-1.5 leading-relaxed">Berdiri 1994, SMA N 5 Rembang berawal dari 3 ruang kelas. Kini 32 tahun mengabdi dengan akreditasi A, 1.200+ siswa, dan puluhan prestasi tiap tahun.</p>
            </div>
