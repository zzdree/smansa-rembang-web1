  ...
  return (
    <section id="blog" className="py-14 lg:py-20 bg-white scroll-mt-[64px]">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <h2 className="text-center mt-2 text-[clamp(28px,4vw,38px)] font-extrabold tracking-[-0.02em] leading-tight">Kabar Terbaru SMA N 5 Rembang</h2>
        ...
        <DetailModal open={!!active} onClose={()=>setActive(null)} title={active?.title ?? ""}>
          {active && <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-black/60">Informasi lengkap hubungi TU / wali kelas. Berita diterbitkan oleh Humas SMA N 5 Rembang.</p>
          </div>}
        </DetailModal>
      </div>
    </section>
