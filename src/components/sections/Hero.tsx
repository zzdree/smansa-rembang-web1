      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-8 py-14 lg:py-20 items-center">
          <div>
            ...
            <motion.p initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.6,ease,delay:0.18}} className="mt-4 text-white/65 max-w-[48ch] leading-relaxed text-[15px]">SMA Negeri X Rembang (sekolah fiktif) — membina 1.200+ peserta didik dengan kurikulum merdeka, fasilitas modern & pembinaan prestasi nasional.</motion.p>
