      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8 py-12 lg:py-16 relative">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-8 items-center">
          <div>
            ...
            <h2 className="mt-2 text-[clamp(28px,4.5vw,42px)] font-extrabold tracking-[-0.02em] leading-[0.95]">Siap bergabung<br/>di <span className="text-[var(--yellow)]">SMA Negeri X Rembang?</span></h2>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <a href="tel:+62295123456" className="h-11 px-6 rounded-full bg-white/10 border border-white/20 inline-flex items-center gap-2 hover:bg-white/15 active:scale-[0.97] transition text-sm font-semibold"><Phone size={16}/> (0295) - 000000</a>
            </div>
            <div className="mt-5 flex flex-wrap gap-2 text-xs">
              <span className="px-3 py-1.5 rounded-full bg-white/10 border border-white/15 inline-flex items-center gap-1.5"><Mail size={12}/> info@example.sch.id</span>
          ...
          <div className="bg-white text-[var(--text-dark)] rounded-[20px] p-5 border border-black/5 shadow-[0_24px_64px_rgba(0,0,0,0.25)]">
            ...
            <p className="text-xs text-black/55 mt-1 leading-relaxed">SMA Negeri X Rembang — Jl. Pahlawan No. 68, Tasikagung, Rembang, Jawa Tengah 59212</p>
            <div className="mt-4 aspect-[16/10] rounded-[16px] overflow-hidden bg-[var(--bg-light)] border border-black/5">
              <iframe title="Peta SMA Negeri X Rembang" src="https://www.google.com/maps?q=-6.6999767,111.3198523&z=15&output=embed" className="w-full h-full border-0" loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen />
            </div>
