...
const socials = [
  { s: "X", label: "X (Twitter) SMA N 1 Rembang" },
  { s: "in", label: "LinkedIn SMA N 1 Rembang" },
  { s: "IG", label: "Instagram SMA N 1 Rembang" },
  { s: "YT", label: "YouTube SMA N 1 Rembang" },
] as const
  ...
  return (
    <footer id="contact" className="bg-[var(--green-dark)] text-white scroll-mt-[64px]">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <div className="py-6 border-t border-white/10 text-xs opacity-60 text-center">© 2026 SMA Negeri 1 Rembang. All rights reserved. Template portofolio by Andreas (zzdree).</div>
      </div>
    </footer>
  )
}