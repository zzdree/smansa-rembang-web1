...
export const metadata: Metadata = {
  metadataBase: new URL("https://smanma-rembang-web.pages.dev"),
  ...
  openGraph: { title: "SMA Negeri 5 Rembang", description: "Sekolah Unggul, Berkarakter, Berprestasi — Kabupaten Rembang, Jawa Tengah", type: "website", url: "https://smanma-rembang-web.pages.dev", siteName: "SMA N 5 Rembang", locale: "id_ID", images: [{ url: "/images/hero/hero-1.jpg", width: 1200, height: 630, alt: "Gedung SMA N 5 Rembang" }] },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const jsonLd = {
    ...
    url: "https://smanma-rembang-web.pages.dev",
