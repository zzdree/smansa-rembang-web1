  ...
  return (
    <div className="min-h-[70vh] grid place-items-center bg-[var(--bg-light)] px-6 py-16">
      <div className="max-w-[560px] w-full bg-white border rounded-[24px] p-8 sm:p-10 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm leading-relaxed text-black/60">Alamat dipindahkan atau salah ketik. Kembali ke beranda atau hubungi TU SMA Negeri X Rembang.</p>
        ...
        <p className="mt-6 text-xs text-black/30">SMA Negeri X Rembang - Akreditasi A - Rembang, Jawa Tengah</p>
      </div>
    </div>
  )
}